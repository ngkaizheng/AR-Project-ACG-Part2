...
//         float flySpeed = 10.0f * birdScale; // Consistent speed for flight
//         distanceToTarget = Vector3.Distance(transform.position, target);
//         while (distanceToTarget > 0.5f * birdScale)
//         {
//             if (!paused)
//             {
...
//                 transform.position = Vector3.SmoothDamp(transform.position, target, ref velocity, 0.5f, 10.0f * birdScale);
//                 distanceToTarget = Vector3.Distance(transform.position, target);
